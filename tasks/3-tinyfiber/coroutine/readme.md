...
Для остановки планировщика нужно вызвать метод `Shutdown`. После этого вызова потоки планировщика будут работать до тех пор, пока очередь задач не опустеет.
