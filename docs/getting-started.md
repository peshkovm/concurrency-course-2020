...
1. Заведите в удобном месте директорию для работы с курсом:
...
3. Подтяните необходимые репозиторию сабмодули:
...
4. На этом шаге нужно подготовить рабочее окружение для работы с репозиторием

Вариантов – два:
* Рекомендуемый – вы разворачиваете докер-контейнер со всеми необходимыми зависимостями и работаете в нем
* Вы сами устанвливаете необходимые зависимости в хост-систему  

6. Перейдите в папку `tpcc-course-2020/docker`.
