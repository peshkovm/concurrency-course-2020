...
Логика по управлению очередью спящих файберов должна быть инкапсулирована в отдельном классе. Тщательно продумайте интерфейс такой очереди. Рекомендуем начать с изменения цикла планирования: _сначала_ подобрать удобный интерфейс, и только _после_ писать реализацию.
