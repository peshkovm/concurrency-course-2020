...
Не используйте `BlockingQueue`: 1) в strand-е не предполагается никакого блокирующего ожидания 2) сам по себе интерфейс блокирующей очереди противоречит идее батчинга.
