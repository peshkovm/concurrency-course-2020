...
Разобраться в поведении этих функций проще всего с помощью [юнит-тестов](unit_test.cpp).
...
- Зато из одного вызова `Capture(&ctx)` можно вернуться несколько раз: первый раз – как из обычного вызова, а последующие – после прыжков
